...
export async function GET(_request: Request, { params }: MediaRouteContext) {
  ...
  if ((!key.startsWith("equipment/") && !key.startsWith("favicon/") && !key.startsWith("hero/") && !key.startsWith("logo/") && !key.startsWith("portfolio/")) || key.includes("..")) return new Response("Not found", { status: 404 });
