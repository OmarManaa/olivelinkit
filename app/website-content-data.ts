...
export const defaultWebsiteContent: WebsiteContent = {
  ...
  heroTitle: "Reliable IT support, website design,",
  heroAccent: "and business technology for local companies.",
  heroLead: "Practical IT support, business website design, and clear technology advice for Melbourne small businesses. Get the right next step for your website, network, or data recovery without enterprise-sized complexity.",
