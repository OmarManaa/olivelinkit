...
export const defaultWebsiteContent: WebsiteContent = {
  brandTitle: "OliveLink IT Solutions",
  ...
  logoAlt: "OliveLink IT Solutions logo",
  showBrandText: true,
  headerCta: "Request support",
  heroEyebrow: "URGENT IT SUPPORT FOR MELBOURNE SMBs",
  heroTitle: "Fast IT support for",
  heroAccent: "Melbourne small business.",
  heroLead: "When a network, PC, email account, or website is stopping work, get practical remote or onsite help with clear next steps before you spend.",
  heroImageUrl: "/hero-it-support.webp",
  heroPrimaryCta: "Start support request",
  heroSecondaryCta: "View common fixes",
  trustItems: ["Emergency triage", "Melbourne onsite visits", "Remote support available"],
  serviceHighlights: [
    { title: "Fast first response", text: "Urgent outages, crashes, and account lockouts are prioritised." },
    { title: "Remote or onsite", text: "Help where it is needed, from home offices to growing teams." },
    { title: "Clear pricing", text: "Options and costs are explained before work proceeds." },
  ],
  ...
  supportEyebrow: "QUICK TRIAGE",
  supportTitle: "Tell us what stopped working.",
  supportText: "Choose the problem, add the key symptoms, then send it through the best channel for fast follow-up.",
  supportPoints: ["Emergency triage", "Remote help", "Onsite visits"],
  ...
  footerText: "OliveLink IT Solutions - Melbourne",
