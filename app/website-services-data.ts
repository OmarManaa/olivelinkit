...
export const defaultWebsiteServices: WebsiteService[] = [
  ...
  { id: "business-it", title: "Business IT", requestType: "Business IT", text: "Microsoft 365, email migrations, NAS, backups, VPN, remote access and practical IT improvements.", icon: "business" },
